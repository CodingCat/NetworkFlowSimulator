...
public class NFSXmlParser {
	private static NFSXmlParser _instance = null;
	private HashMap<String, String> propertyMap = null;
	private String confPath = null;
	
	private NFSXmlParser(String path){
		this.confPath = path;
	 ...
	 */
	public static NFSXmlParser Instance(String confPath){
		if (_instance == null){
			_instance = new NFSXmlParser(confPath);
		}
		return _instance;
	}
