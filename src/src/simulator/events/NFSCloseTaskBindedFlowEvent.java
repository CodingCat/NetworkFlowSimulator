...
public class NFSCloseTaskBindedFlowEvent extends
		EventOf2Entities<NFSMapReduceApplication.MapTask, NFSTaskBindedFlow> {
	...
	@Override
	public void eventRoutine(NFSMapReduceApplication.MapTask task, NFSTaskBindedFlow flow) {
		task.close(flow);
	}
